...
export function parse_vb6_code(code, _file_type) {
    ...
    const ptr1 = passStringToWasm0(_file_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.parse_vb6_code(ptr0, len0, ptr1, len1);
    if (ret[2]) {
...
export function tokenize_vb6_code(code) {
    const ptr0 = passStringToWasm0(code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.tokenize_vb6_code(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
