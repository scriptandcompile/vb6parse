...
fn chess_brain_vb_debugmain_frx() {
    let result = FormResourceFile::from_file("./tests/data/ChessBrainVB/ChessBrainVB_V4_03a/Source/Forms/DebugMain.frx")
...
fn chess_brain_vb_frmchessx_frx() {
    let result = FormResourceFile::from_file("./tests/data/ChessBrainVB/ChessBrainVB_V4_03a/Source/Forms/frmChessX.frx")
        .expect("Failed to read file");
...
fn chess_brain_vb_main_frx() {
    let result = FormResourceFile::from_file("./tests/data/ChessBrainVB/ChessBrainVB_V4_03a/Source/Forms/main.frx")
        .expect("Failed to read file");
