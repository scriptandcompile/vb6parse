                    ...
                    AssignmentStatement {
                        ...
                        CallExpression {
                            ...
                            ArgumentList {
                                Argument {
                                    StringLiteralExpression {
                                        StringLiteral ("\"Operation complete\""),
                                    },
                                },
                                Comma,
                                Whitespace,
