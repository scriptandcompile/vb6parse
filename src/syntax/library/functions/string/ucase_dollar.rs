...
"#;
        ...
        assert_tree!(cst, [
            ...
            FunctionStatement {
                FunctionKeyword,
                Whitespace,
                Identifier ("GenerateConstantName"),
                ParameterList {
                    LeftParenthesis,
                    Identifier ("baseName"),
                    Whitespace,
...
";
        ...
        assert_tree!(cst, [
            ...
            FunctionStatement {
                FunctionKeyword,
                Whitespace,
                Identifier ("NormalizeRegistryKey"),
                ParameterList {
                    LeftParenthesis,
                    Identifier ("keyName"),
                    Whitespace,
...
";
        ...
        assert_tree!(cst, [
            ...
            FunctionStatement {
                FunctionKeyword,
                Whitespace,
                Identifier ("GenerateReportHeader"),
                ParameterList {
                    LeftParenthesis,
