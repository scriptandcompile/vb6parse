            ...
            IfStatement {
                ...
                StatementList {
                    ...
                    CallStatement {
                        Identifier ("MsgBox"),
                        Whitespace,
                        StringLiteral ("\"Replacement successful\""),
                        Newline,
                    },
                },
                EndKeyword,
...
"#;
        ...
        assert_tree!(cst, [
            ...
            FunctionStatement {
                FunctionKeyword,
                Whitespace,
                Identifier ("RemoveSpaces(text As String) As String"),
                Newline,
                StatementList {
                    Whitespace,
                    RemComment,
            ...
            SubStatement {
                ...
                StatementList {
                    ...
                    CallStatement {
                        Identifier ("MsgBox"),
                        Whitespace,
                        StringLiteral ("\"Error in text replacement\""),
                        Newline,
                    },
                },
                EndKeyword,
