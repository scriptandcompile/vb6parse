            ...
            IfStatement {
                ...
                StatementList {
                    ...
                    CallStatement {
                        Identifier ("MsgBox"),
                        Whitespace,
                        StringLiteral ("\"Payoff will take over 5 years\""),
                        Newline,
                    },
                },
                EndKeyword,
...
";
        ...
        assert_tree!(cst, [
            ...
            FunctionStatement {
                FunctionKeyword,
                Whitespace,
                Identifier ("CalculatePayoffMonths"),
                ParameterList {
                    LeftParenthesis,
                    Identifier ("loan"),
                    Whitespace,
...
"#;
        ...
        assert_tree!(cst, [
            ...
            CallStatement {
                Identifier ("MsgBox"),
                Whitespace,
                StringLiteral ("\"Months to payoff: \""),
                Whitespace,
                Ampersand,
                Whitespace,
                Identifier ("Format"),
            ...
            IfStatement {
                ...
                StatementList {
                    ...
                    CallStatement {
                        Identifier ("MsgBox"),
                        Whitespace,
                        StringLiteral ("\"Rate 1 is faster\""),
                        Newline,
                    },
                },
                EndKeyword,
...
";
        ...
        assert_tree!(cst, [
            ...
            CallStatement {
                CallKeyword,
                Whitespace,
                Identifier ("DisplayPayoffSchedule"),
                LeftParenthesis,
                Identifier ("NPer"),
                LeftParenthesis,
                Identifier ("apr"),
            ...
            IfStatement {
                ...
                StatementList {
                    ...
                    CallStatement {
                        Identifier ("MsgBox"),
                        Whitespace,
                        StringLiteral ("\"Invalid calculation\""),
                        Newline,
                    },
                },
                EndKeyword,
