            ...
            SubStatement {
                ...
                StatementList {
                    OnErrorStatement {
                        ...
                        GotoKeyword,
                        Whitespace,
                        Identifier ("TransError"),
                        Newline,
                    },
                    Whitespace,
                    CallStatement {
                        Identifier ("BeginTrans"),
                        Newline,
                    },
                    Whitespace,
                    EndOfLineComment,
