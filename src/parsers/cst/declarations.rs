//! Declaration statements for VB6 CST.
//!
//! This module handles parsing of VB6 declaration statements:
//! - Sub statements
//! - Declare statements (external function/sub declarations)
//!
...
//!
//! [Sub Reference](https://learn.microsoft.com/en-us/office/vba/language/reference/user-interface-help/sub-statement)
