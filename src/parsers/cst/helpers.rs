...
impl<'a> Parser<'a> {
    ...
    pub(super) fn peek_next_count_keywords(&self, count: NonZeroUsize) -> impl Iterator<Item = VB6Token> + '_ {
        self.tokens
            .iter()
            .skip(self.pos + 1)
    ...
    pub(super) fn peek_next_count_tokens(&self, count: NonZeroUsize) -> impl Iterator<Item = VB6Token> + '_ {
        self.tokens
            .iter()
            .skip(self.pos + 1)
            .take(count.get())
