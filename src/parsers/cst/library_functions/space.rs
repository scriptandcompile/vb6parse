...
";
        ...
        let debug = tree.debug_tree();
        assert!(debug.contains("Space"));
        assert!(debug.contains("CreatePadding"));
    }
...
";
        ...
        let debug = tree.debug_tree();
        assert!(debug.contains("Space"));
        assert!(debug.contains("ProcessText"));
    }
...
";
        ...
        let debug = tree.debug_tree();
        assert!(debug.contains("Space"));
        assert!(debug.contains("isCorrect"));
    }
...
"#;
        ...
        let debug = tree.debug_tree();
        assert!(debug.contains("Space"));
        assert!(debug.contains("indentedText"));
    }
