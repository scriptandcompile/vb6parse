...
impl From<VB6Token> for SyntaxKind {
    fn from(token: VB6Token) -> Self {
        match token {
            ...
            VB6Token::GoSubKeyword => SyntaxKind::GoSubKeyword,
            VB6Token::ReturnKeyword => SyntaxKind::ReturnKeyword,
            ...
            VB6Token::MidBKeyword => SyntaxKind::MidBKeyword,
            ...
            VB6Token::UnloadKeyword => SyntaxKind::UnloadKeyword,
            ...
            VB6Token::RandomKeyword => SyntaxKind::RandomKeyword,
            VB6Token::ReadKeyword => SyntaxKind::ReadKeyword,
            VB6Token::OutputKeyword => SyntaxKind::OutputKeyword,
            VB6Token::AppendKeyword => SyntaxKind::AppendKeyword,
            VB6Token::AccessKeyword => SyntaxKind::AccessKeyword,
            VB6Token::TextKeyword => SyntaxKind::TextKeyword,
            VB6Token::DatabaseKeyword => SyntaxKind::DatabaseKeyword,
            VB6Token::EmptyKeyword => SyntaxKind::EmptyKeyword,
            VB6Token::ModuleKeyword => SyntaxKind::ModuleKeyword,
            ...
            VB6Token::LeftParenthesis => SyntaxKind::LeftParenthesis,
            VB6Token::RightParenthesis => SyntaxKind::RightParenthesis,
            ...
            VB6Token::InequalityOperator => SyntaxKind::InequalityOperator,
            VB6Token::LessThanOrEqualOperator => SyntaxKind::LessThanOrEqualOperator,
            VB6Token::GreaterThanOrEqualOperator => SyntaxKind::GreaterThanOrEqualOperator,
